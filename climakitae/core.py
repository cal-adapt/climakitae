...
# === Visualize =============================
def get_global_warming_levels(smoothed,degrees):
    ''' This needs to be better generalized to do the appropriate smoothing, and work regardless of the dimensions
    in the passed-in xarray Dataset'''
