...
This code has been ported from the cae-notebooks persistence_extreme_meteorological_year 
and shock_extreme_meteorological_year notebooks.
It includes statistical code for creating percentiles and the F-S statistic
along with an XMY class that organizes the workflow code.
"""
