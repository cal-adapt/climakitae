...
class ThresholdDataParams(param.Parameterized):
    ...
    def group_row(self):
        ...
        return pn.Row(
            self.param.group_length,
            self.param.group_type,
            width = 375
        )
    ...
    def duration2_row(self):
        ...
        return pn.Row(
            self.param.duration2_length,
            self.param.duration2_type,
            width = 375
        )
