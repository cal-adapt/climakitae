    ...
    def _GMT_context_plot(self):
        ...
        if self.ssp != "All":
            ...
            if (np.argmax(ssp_selected["Mean"] > self.warmlevel)) > 0:
                ...
                year_warmlevel_reached = ssp_selected.where(
                    ssp_selected["Mean"] > self.warmlevel).dropna().index[0]
                ssp_int = hv.Curve(
                    [[year_warmlevel_reached, -2],
                    [year_warmlevel_reached, 10]],
                    label = label1
