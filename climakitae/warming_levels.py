...
def _display_warming_levels(warming_data, selections):
    ...
    data_options = pn.Card(
        pn.Row(
            ...
            pn.Column(
                pn.widgets.FloatSlider.from_param(selections.param.latitude, width=200),
                pn.widgets.FloatSlider.from_param(selections.param.longitude, width=200),
