...
The ClimateData interface supports the catalogs that ship with `climakitae 1.5.x` (`cadcat`, `renewable energy generation`, `hdp`, `sup3rcc`). All new features land here. See [Legacy API status](../legacy/index.md#status-and-roadmap) for the migration timeline.
