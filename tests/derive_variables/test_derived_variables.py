...
def test_precip_check_expected_value(test_data_2022_monthly_45km): 
    ...
    test_data_subset = test_data_2022_monthly_45km.sel(simulation="cesm2", scenario="SSP 2-4.5 -- Middle of the Road", time="2022-01-01") # Get small subset of testing data 
