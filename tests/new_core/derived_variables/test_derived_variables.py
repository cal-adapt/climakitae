...
class TestLegacyDerivedVariables:
    """Test class for legacy derived variable functions from climakitae.tools."""

    @pytest.fixture
    def rel_humidity(self, test_data_2022_monthly_45km):
    ...
    @pytest.fixture
    def wind_mag(self, test_data_2022_monthly_45km):
    ...
    @pytest.fixture
    def wind_dir(self, test_data_2022_monthly_45km):
    ...
    @pytest.fixture
    def dew_pnt(self, rel_humidity, test_data_2022_monthly_45km):
    ...
    @pytest.fixture
    def spec_humidity(self, dew_pnt, test_data_2022_monthly_45km):
    ...
    def test_expected_return_type(self, rel_humidity, wind_mag, dew_pnt, spec_humidity):
