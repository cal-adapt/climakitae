...
class TestRenewablesValidatorWarningLevelProcessor:
    """Test class for RenewablesValidator warming level processor validation."""
    ...
    def test_check_query_for_warming_level_processor_valid_no_warming_level(self):
        """Test _check_query_for_warming_level_processor with no warming_level processor.

        Tests that queries without the warming_level processor return True.
        """
        query = {"variable_id": "cf", "activity_id": "LOCA2"}

        result = self.validator._check_query_for_warming_level_processor(query)

        assert result is True

    def test_check_query_for_warming_level_processor_invalid(self):
        """Test _check_query_for_warming_level_processor with warming_level processor.

        Tests that queries with the warming_level processor return False and
        emit a proper warning.
        """
        query = {
            "processes": {"warming_level": {"warming_levels": [1.5, 2.0]}},
            "variable_id": "cf",
            "activity_id": "LOCA2",
        }
